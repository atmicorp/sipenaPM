    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Reset Penilaian Magang</h3>
          ...
          <div class="row">
            ...
            <!-- Peringatan -->
                <div class="alert alert-warning">
                    <strong>Perhatian!</strong> Mengklik tombol reset akan menghapus <strong>seluruh data penilaian</strong>. Data yang terhapus tidak dapat dikembalikan.
                </div>

                <!-- Tombol Reset -->
                <form action="{{ route('deletepenilaianmagang') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data?')">
                    @csrf
                    <button type="submit" class="btn btn-danger">
                        <i class="fas fa-trash-alt"></i> Reset Data Penilaian
                    </button>
                </form>
            </div>
          </div>
