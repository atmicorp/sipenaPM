...
class AspekPenilaianTA extends Model
{
    use HasFactory;
    protected $table = 'aspek_penilaian_t_a_s'; // Menentukan nama tabel yang digunakan oleh model ini
    ...
    {
        return $this->hasMany(penilaianTA::class, 'id_aspekTA');  
    }
}
